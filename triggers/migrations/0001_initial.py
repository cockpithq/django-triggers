    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('number_limit', models.PositiveIntegerField(blank=True, default=1, help_text='Maximal number of actions that can be triggered for the user.', null=True, validators=[django.core.validators.MinValueValidator(1)], verbose_name='number limit')),
                ('frequency_limit', models.DurationField(blank=True, default=datetime.timedelta(days=30), help_text='Minimal period of time that should run out before the next action can be triggered.', null=True, verbose_name='frequency limit')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('last_execution_datetime', models.DateTimeField(blank=True, null=True, verbose_name='executed at')),
                ('execution_count', models.PositiveIntegerField(default=0, verbose_name='number of executions')),
                ('polymorphic_ctype', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='polymorphic_%(app_label)s.%(class)s_set+', to='contenttypes.contenttype')),
            ...
            options={
                'verbose_name': 'trigger activity',
                'verbose_name_plural': 'trigger activities',
